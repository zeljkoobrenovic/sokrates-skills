...
codex exec "Use skills from _sokrates/sokrates-skills/config (see SKILL.md) to improve the sokrates configuration by breaking it down into clear parts and identifying important features. Improve the people setup to remove repeated contributors in commit analysis. Finish analyses in 1 minute." --sandbox workspace-write

echo "Generating sokrates reports (after configuration changes)..."
sokrates generateReports

echo "Starting full AI-Insight scan using sokrates skills..."
codex exec "Use skills from _sokrates/sokrates-skills/scanners (see SKILL.md) and do a full scan. Finish analyses in 1 minute." --sandbox workspace-write
